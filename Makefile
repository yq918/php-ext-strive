srcdir = /zhang/php-7.1.0/ext/strive
builddir = /zhang/php-7.1.0/ext/strive
top_srcdir = /zhang/php-7.1.0/ext/strive
top_builddir = /zhang/php-7.1.0/ext/strive
...
RE2C = exit 0;
AWK = gawk
shared_objects_strive = strive.lo
PHP_PECL_EXTENSION = strive
PHP_MODULES = $(phplibdir)/strive.la
PHP_ZEND_EX =
...
prefix = /usr/local/php
phplibdir = /zhang/php-7.1.0/ext/strive/modules
